...
<footer>FINANCIAL FREEDOM OS &nbsp;|&nbsp; EDUCATION ONLY — NOT FINANCIAL ADVICE &nbsp;|&nbsp; &copy; {{ year }}</footer>
</body>
</html>"""
...
def home():
    ...
    body = """
<div class="grid grid-2" style="min-height:70vh;align-items:center;gap:2rem;">
  <div>
    <div class="section-label">Financial Freedom OS</div>
    <h1 style="font-size:2.4rem;line-height:1.1;margin-bottom:1rem;">Build wealth.<br><span class="green cursor">Track everything.</span></h1>
    <p class="muted" style="font-size:.95rem;max-width:420px;margin-bottom:1.5rem;line-height:1.8;">
      A serious financial platform for families — Freedom Score, cashflow analysis, debt payoff engine,
      retirement projections, and a complete money education curriculum for adults AND kids.
    </p>
    <div style="display:flex;gap:.75rem;flex-wrap:wrap;">
      <a class="btn btn-primary" href="/signup">Start Free →</a>
      <a class="btn" href="/login">Login</a>
      <a class="btn btn-amber" href="/pricing">See Pricing</a>
    </div>
  </div>
  <div class="grid" style="gap:.75rem;">
    <div class="card card-sm"><div class="section-label">Freedom Score</div>
      <p class="muted" style="font-size:.85rem;">0–100 composite score across cashflow, debt, savings, and spending leaks.</p></div>
    <div class="card card-sm"><div class="section-label">Money Education</div>
      <p class="muted" style="font-size:.85rem;">12 lessons for Adults & Kids with quizzes, progress tracking, and premium unlocks.</p></div>
    <div class="card card-sm"><div class="section-label">Debt Destruction Engine</div>
      <p class="muted" style="font-size:.85rem;">Avalanche or Snowball. Exact month you'll be debt-free.</p></div>
    <div class="card card-sm"><div class="section-label">Retirement Projection</div>
      <p class="muted" style="font-size:.85rem;">Future value + 4%-rule income. Creates urgency + a plan.</p></div>
  </div>
</div>"""
